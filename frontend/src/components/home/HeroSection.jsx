        ...
        <div className=" container mx-auto flex flex-col items-center py-12 sm:py-24">
          <div className="  w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
            ...
            <p className=" mt-5 sm:mt-10 lg:w-10/12  text-black font-normal text-center text-sm sm:text-lg">
              After decades of no innovation in the luggage industry, we
              re-imagined the suitcase to solve all the problems of the modern
              traveler. No more luggage nightmares to spoil your trips. With{" "}
              <b>SCS</b> , you will travel smarter and be the coolest kid in the
              airport.
            </p>
          </div>
